...
const Canvas: React.FC<CanvasProps> = ({ 
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4 relative animate-zoom-in group">
      ...
      {/* Feedback Panel */}
      {displayImageUrl && !isLoading && user && sessionId && (
          ...
          <AnimatePresence>
            {showFeedback ? (
              ...
              <motion.button
                ...
                className="bg-white/60 backdrop-blur-sm border border-gray-300/80 text-gray-700 font-medium py-2 px-4 rounded-full transition-all duration-200 ease-in-out hover:bg-white hover:border-gray-400 active:scale-95 text-sm"
              >
                💭 Give Feedback
              </motion.button>
            )}
